    ...
    <>
      ...
      <div className={styles.homeContainer}>
        ...
        <div className={styles.contentContainer}>
          <h3>
            Esto es un demo para medir la frecuencia cardiaca con video basado en un artículo
            de investigación de Xin Liu et al adaptado.
          </h3>
          <h4 style={{ color: 'red' }}>
            Porfavor dejar tu cara en el cuadrado por 30 segundos sin moverte
          </h4>
          {!isRecording && (
            <button
